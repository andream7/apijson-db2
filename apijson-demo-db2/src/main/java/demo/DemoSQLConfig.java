...
public class DemoSQLConfig extends APIJSONSQLConfig {
	...
	static {
		DEFAULT_DATABASE = DATABASE_DB2;  // TODO 默认数据库类型，改成你自己的
		DEFAULT_SCHEMA = "DB2ADMIN";  // TODO 默认模式名，改成你自己的，默认情况是 MySQL: sys, PostgreSQL: public, SQL Server: dbo, Oracle:
	...
	public String getDBVersion() {
		return "10.1";  // "8.0.11";  // TODO 改成你自己的 MySQL 或 PostgreSQL 数据库版本号  // MYSQL 8 和 7 使用的 JDBC 配置不一样
	}

	@JSONField(serialize = false)  // 不在日志打印 账号/密码 等敏感信息
	@Override
	public String getDBUri() {
		return "jdbc:db2://127.0.0.1:50000/APIJSON"; // TODO 改成你自己的，TiDB 可以当成 MySQL 使用，默认端口为 4000
	}
